 ...
 <head>
   ...
   <!-- DATATABLES -->
   <link rel="stylesheet" type="text/css" href="../../library/datatables/jquery.dataTables.min.css">
   <link href="../../library/datatables/buttons.dataTables.min.css" rel="stylesheet" />
   <link href="../../library/datatables/responsive.dataTables.min.css" rel="stylesheet" />

   <link rel="stylesheet" type="text/css" href="../../library/css/bootstrap-select.min.css">
            ...
            ?>
             <li class="treeview">
               ...
               <ul class="treeview-menu">
                 ...
                 <li><a href="departamento.php"><i class="fa fa-circle-o"></i> Punto de Venta</a></li>
               </ul>
             </li>

             <li class="treeview">
               <a href="#">
                 <i class="fa fa-folder"></i> <span>Punto De Venta</span>
                 <span class="pull-right-container">
                   <i class="fa fa-angle-left pull-right"></i>
                 </span>
               </a>
